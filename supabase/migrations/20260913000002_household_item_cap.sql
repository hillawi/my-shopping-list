...
-- it updates the existing one. This cap is really "100 distinct item names ever used by a
-- household", not "100 purchases" — expected to comfortably cover a real household's active
